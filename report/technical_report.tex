...
The GERBIL platform computes an F-score over our answers. We evalutated the QALD\_Train as well as the QALD\_Test set.
...
Presumably, our system will have a slightly worse result on other questions sets. Our system provides the foundations to answer a multitude of questions, so it could easily be extended to further improve the result.\\
